...
def visualize_trajectory(target_positions, truth_trajectory, path):
...
if __name__ == '__main__':
    traj = np.load('pick_traj.npy', allow_pickle=True)
    context = np.load('pick_context.npy', allow_pickle=True)
    visualize_trajectory(context, traj, path="plots/")
